...
function showMeal(meals) {
  ...
  for (let meal of meals) {
    document.querySelector(".meal-wrapper").innerHTML += `
      <div class="meal-box border border-gray-500">
          ...
          />
      <div class="p-3">
          <h3 class="heading text-white text-2xl pt-3">${meal.strMeal}</h3>
  ...
  <a href=${
    meal.strYoutube
  } target="_blank" class="btn bg-orange-500 hover:bg-orange-700 text-white px-4 py-2 rounded">Watch</a>
  <button class="px-3 text-white" onclick="lookupDetails('${meal.idMeal}')">
    View Recipe
  </button>
</div> 
      </div>
...
function showMealDetails(meal) {
  ...
  <div class="popup bg-white w-[70%] min-h-[500px] p-10">
      ...
      <a href=${meal.strYoutube}
          class="px-4 py-2 mr-5 bg-blue-500 hover:bg-blue-600 text-white rounded">
          Watch
      </a>
